...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-8">
                Ferramentas possuem isolamento adequado e resistem a voltagem max. dos equipamentos energizados
            </div>
            <div class="col-md-4">
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-8">
                Papete de borracha ou outro material  isolante
            </div>
            <div class="col-md-4">
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-8">
                O acesso aos dispositivos de parada do circuito elétrico e botão de emergência estão desobstruídos para acionamento
            </div>
            <div class="col-md-4">
                <div class="form-inline">
                    <div class="form-check">
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-8">
                Equipamento de proteção para alta tensão
            </div>
            <div class="col-md-4">
                <div class="form-inline">
                    <div class="form-check">
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-8">
               Executantes conhecem o funcionamento do equipamento
            </div>
            <div class="col-md-4">
                <div class="form-inline">
                    <div class="form-check">
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-8">
               Executantes possuem Qualificação/Habilitação/Autorização conforme NR10
            </div>
            <div class="col-md-4">
                <div class="form-inline">
                    <div class="form-check">
