...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-8">
                Avaliar capacidade máxima do equipamento e carga a ser içada
            </div>
            <div class="col-md-4">
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-8">
                Verificar isolamento/sinalização segura para pessoas e veículos
            </div>
            <div class="col-md-4">
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-8">
                Definir a assegurar distância mínima dos envolvidos com a carga
            </div>
            <div class="col-md-4">
                <div class="form-inline">
                    <div class="form-check">
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-8">
                Avaliado interferências da lança com tubulações, redes energizadas ou estruturas
            </div>
            <div class="col-md-4">
                <div class="form-inline">
                    <div class="form-check">
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-8">
                Cabo guia amarrado nas carga para manobras
            </div>
            <div class="col-md-4">
                <div class="form-inline">
                    <div class="form-check">
